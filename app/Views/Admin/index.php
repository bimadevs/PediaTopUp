...
<div class="row">
              ...
              <div class="col-md-3 stretch-card grid-margin">
                <div class="card bg-gradient-warning card-img-holder text-white">
                  <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image">
                    <h4 class="font-weight-normal mb-3">Penarikan Pending <i class="mdi mdi-cash-refund mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5"><?= $total['pending_withdrawals'] ?></h2>
                    <a href="/admin/withdrawal" class="card-text" style="text-decoration: none; color: #fff;">Lihat Detail <i class="mdi mdi-arrow-right mdi-24pxt"></i></a>
                  </div>
                </div>
              </div>
            </div>
